...
async def insert_lead(lead: Lead) -> None:
    async with AsyncSessionLocal() as session:
        orm = LeadORM(
            ...
            instagram_following=lead.instagram_following,
            instagram_posts=lead.instagram_posts,
            instagram_engagement_rate=lead.instagram_engagement_rate,
            instagram_account_type=lead.instagram_account_type,
